...
var settlement_manage_data = function(){
	...
	$.post("settlement_manage_data.do", param, function(data) {
		$("#settlement_manage_data").html(data);
	});
}
...
var settlement_manage_init = function(){
	$("#start_datetime").val('');
	$("#end_datetime").val('');
	$("#search_nm").val('');
}
...
var detail = function(param1, param2){
	...
	$.post("settlement_manage_info.do", param, function(data) {
		$("#dim").html(data);
	});
}
