...
<script src="/app/js/manage_all_search.js"></script>
        ...
        <div class="inner">
            <form name="frm" id="frm" action="" method="post">
                <fieldset>
                    ...
                    <div class="send_btn">
                        <button onclick="manage_all_data();" class="btn-active" type="button">내역조회</button>
                        <button onclick="manage_all_init();" class="btn-default" type="reset">초기화</button>
                    </div>
                </fieldset>
