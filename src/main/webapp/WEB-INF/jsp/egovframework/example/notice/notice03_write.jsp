...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<script src="/js/notice03_write.js"></script>	
	<!-- container -->
	
				<div class="inner clearfix">
					<div class="col">
						<strong class="sub_ttl">자주묻는질문</strong>
						...
						<input type="hidden" name="arrChk" id="arrChk"/>
							...
							<table>
								<tbody>
									...
									<tr class="input_box input_box_border">
										...
										<td class="input_desc" colspan="7"><input class="width_all" type="text" id="title" name="title" value="${noticeVO.title }"></td>
									</tr>
									<tr class="input_box input_box_border editor">
										<td class="input_ttl" colspan="1"><label class="" for="">내용</label>
										</td>
										<td class="input_desc" colspan="7"><textarea id="content" name="content" cols="202" rows="7">${noticeVO.content }</textarea></td>
									</tr>
									<tr class="input_box input_box_border comment">
										<td class="input_ttl" colspan="1"><label class="" for="">답변</label>
										</td>
										<td class="input_desc" colspan="7"><textarea class="width_all" name="reply" id="reply" cols="202" rows="7">${noticeVO.reply }</textarea></td>
									</tr>
	                        ...
	                        <div class="btn_box">
	                        	<a href="/notice/notice03.do?view_type=L" class="a_btn a_btn_blue_line">이전</a>
	                        	<c:if test="${view_type eq 'I'}">
	                            ...
	                            <a href="/notice/notice03.do" class="a_btn a_btn_default">목록</a>
	                        </div>
						</form>
					</div>
				</div>
