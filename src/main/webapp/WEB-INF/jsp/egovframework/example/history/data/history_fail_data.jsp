					...
					<table>
                        ...
                        <thead>
                            <tr>
                                ...
                                >주문번호</button></th>
                                <th><button type="button">거래상태</button></th>
						...
						<c:choose>
							<c:when test="${!empty resultList}">						
								...
								<tr>
                                    ...
                                    <td class="id" onclick="frmView('<c:out value="${result.no}" />','<c:out value="${result.cpid}" />')"><span><c:out value="${result.userid}" /></span></td>
                                    ...
                                    <td>
                                        <span><span class="order_state_finish">결제실패</span></span>
                                    </td>
