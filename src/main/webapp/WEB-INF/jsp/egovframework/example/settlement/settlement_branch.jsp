...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <script src="/js/settlement_branch.js"></script>
    <script src="/js/table.js"></script>


			    <div class="inner clearfix">
			        <div class="col">
			            <strong class="sub_ttl">대리점별정산조회</strong>
			            ...
			            <input type="hidden" name="order_no" id="order_no" value="1">
			                    ...
			                    <tbody>
			                        ...
			                        <tr class="input_box input_box_border">
			                            ...
			                            <td class="input_desc" colspan="7">
                                            <select class="width_ss" name="bussincess_id" id="bussincess_id">
                                                <option value="branch">대리점</option>
                                            </select>
			                                <select class="width_ss" name="search_id2" placeholder="" id="search_id2">
			                ...
			                <div class="btn_box">
			                    <a href="javascript:settlement_branch_data();" class="a_btn a_btn_blue">내역조회</a> 
			                    <a href="javascript:settlement_branch_init();" class="a_btn a_btn_default">초기화</a>
			                </div>
			            </form>
                    </div>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr class="input_box input_box_border">
                                    ...
                                    <td class="input_desc"><span id="total_vat3"/></td>
                                    <td class="input_ttl">
                                        <label for="">정산금액</label>
                                    </td>
                                    <td class="input_desc"><span id="total_settlement3"/></td>
                                    <td class="input_ttl">
                                        <label for="">총 정산금액</label>
                                    </td>
                                    <td class="input_desc"><span id="total_amount3"/></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
			        ...
			        <div class="col">
			            ...
			            <div id="settlement_branch_data"></div>
