			...
			<div class="inner clearfix">
				<div class="col">
					...
					<form class="form_layout" name="frm1" id="frm1" method="post" action=""	target="" onsubmit="return false;" >
						...
						<table>
							<tbody>
								<tr class="input_box input_box_border">
									...
									<span class="checkbox"> <input type="radio" name="check" value="title" class="input_checkbox" id="title" ${searchNoticeVO.check eq 'title'?'checked':''}>
									<label for="title">제목</label>
									</span> 
									<span class="checkbox"> <input type="radio" name="check" value="content" class="input_checkbox" id="content" ${searchNoticeVO.check eq 'content'?'checked':''}>
						...
						<div class="btn_box">
							<a href="javascript:notice01_data();" class="a_btn a_btn_blue">검색</a>
						</div>
					</form>
				</div>

				<div class="col" id="notice01_data"></div>
