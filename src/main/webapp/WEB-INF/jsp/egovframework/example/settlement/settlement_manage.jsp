...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <script src="/js/table.js"></script>
			    ...
			    <div class="inner clearfix">
			        <div class="col">
			            <strong class="sub_ttl">영업대행별정산조회</strong>
			            ...
			            <input type="hidden" name="order_no" id="order_no" value="1">
			                ...
			                <div class="btn_box">
			                    <a href="javascript:settlement_manage_data();" class="a_btn a_btn_blue">내역조회</a> 
			                    <a href="javascript:settlement_manage_init();" class="a_btn a_btn_default">초기화</a>
			                </div>
			            </form>
                    </div>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr class="input_box input_box_border">
                                    ...
                                    <td class="input_desc"><span id="total_vat2"/></td>
                                    <td class="input_ttl">
                                        <label for="">정산금액</label>
                                    </td>
                                    <td class="input_desc"><span id="total_settlement2"/></td>
                                    <td class="input_ttl">
                                        <label for="">총 정산금액</label>
                                    </td>
                                    <td class="input_desc"><span id="total_amount2"/></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
