...
<meta property="og:url" content="https://headadm.paytune.co.kr/app/">
    ...
    <div class="container">
        <div class="main">
            <section class="login_box">
                <div class="inner">
                    <h1>Welcome</h1>
                    <p class="welcome_txt">페이튠에 오신 것을 환영합니다.</p>
                    ...
                    <p class="copyright">Copyright 2020 paytune. All Rights Reserved</p>
                </div>
            </section>
        </div>
