...
<script src="/app/js/manage_branch_modify.js"></script>
...
<section class="manage_table_basic manage_main">
    ...
    <div class="manage_table_cont">
        <div class="inner">
			<form name="frm" id="frm" method="get" action="" target="">
			...
			<input type="hidden" name="period" id="period" value="30" />
                <fieldset>
                    ...
                    <div class="send_btn">
                        ...
                        <button class="btn-default" onclick="location.href='manage_branch.do'" type="button">목록</button>
                    </div>
                </fieldset>
            </form>
        </div>
