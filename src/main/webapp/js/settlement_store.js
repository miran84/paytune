...
var doExcelDownload = function(){
	...
	f.action = "/settlement/settlement_store_excel.do";
	f.submit();
}

var settlement_store_data = function(){
	...
	$.post("settlement_store_data.do", param, function(data) {
		$("#settlement_store_data").html(data);
	});
}
