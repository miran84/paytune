...
<script src="/app/js/manage2.js"></script>
   
<section class="manage_basic basic_bg">
    <div class="inner">
        <div class="ttl">
            <h2 class="ttl_left">가맹점관리</h2>
            <button onclick="location.href='manage2_search.do'" class="ttl_right" type="button"><span>상세검색</span></button>
        </div>
            ...
            <div class="manage_list">
                <ul onclick="frmView('<c:out value="${result.store_id}" />')">
                    ...
                    <li>
                        ...
                        <span class="list_right">546871200</span>
                    </li>
                    <li>
        ...
        <div class="register_btn">
		    <button onclick="location.href='manage2_register.do'" type="button">가맹점등록</button>
        </div>
        </c:if>
