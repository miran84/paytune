				...
				<div class="col">
					...
					<input type="hidden" name="period" id="period" value="30" />
						<table>
							<tbody>
								...
								<tr class="input_box input_box_border">
									...
									<td class="input_desc" colspan="2"><input class="width_240" type="text" name="hompage" placeholder="" id="hompage"  value="http://"></td>
						...
						<div class="btn_box">
							...
							<a href="javascript:fnSubmit();"  id="frmAdd" class="a_btn a_btn_blue">등록하기</a> <a href="/manage/manage_all.do" class="a_btn a_btn_default" >목록</a>
						</div>
					</form>
				</div>
			</div>
