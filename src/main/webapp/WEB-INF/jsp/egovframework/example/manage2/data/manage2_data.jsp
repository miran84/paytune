						...
						<table>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    >회사번호</button></th>
                                    <th class="manager"><button type="button" id="btn_commission" onclick="frmOrder('commission');"
        								<c:if test="${searchManage2VO.order_id eq 'commission' and searchManage2VO.order_no eq '1'}">class="up"</c:if>
        								<c:if test="${searchManage2VO.order_id eq 'commission' and searchManage2VO.order_no eq '2'}">class="down"</c:if>                                    
                                    >수수료</button></th>
							...
							<c:choose>
								...
								<tr>
									...
									<td class="id" onclick="frmView('<c:out value="${result.store_id}" />')"><span><c:out value="${result.store_id}" /></span></td>
									...
									<td class="manager"><span><c:out value="${result.commission}" />%</span></td>
									...
									<td class="status"><span><c:out value="${result.state eq 'Y'?'사용':'중지'}" /></span></td>
									<td class="management">
