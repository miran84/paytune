...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<script src="/js/notice06_write.js"></script>	
	<!-- container -->
	
				<div class="inner clearfix">
					<div class="col">
						<strong class="sub_ttl">1:1문의(영업대행)</strong>
						...
						<input type="hidden" name="file_type" id="file_type" value="no6" />
						<input type="hidden" name="arrChk" id="arrChk"/>
	                        ...
	                        <div class="btn_box">
	                        	<a href="/notice/notice06.do?view_type=L" class="a_btn a_btn_blue_line">이전</a>
							    <c:choose>
								    <c:when test="${sessionScope.role_id eq '1001'}">
	                            ...
	                            <a href="/notice/notice06.do" class="a_btn a_btn_default">목록</a>
	                        </div>
						</form>
					</div>
				</div>
