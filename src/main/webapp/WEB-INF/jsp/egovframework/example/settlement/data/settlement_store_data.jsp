                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><button type="button" id="btn_period_date" onclick="frmOrder('period_date');"
    							<c:if test="${searchSettlementVO.order_id eq 'period_date' and searchSettlementVO.order_no eq '1'}">class="up"</c:if>
    							<c:if test="${searchSettlementVO.order_id eq 'period_date' and searchSettlementVO.order_no eq '2'}">class="down"</c:if>                                
                                >정산일</button></th>
                                <th><button type="button" id="btn_store_id" onclick="frmOrder('store_id');"
                                ...
                                >가맹점ID</button></th>
                                <th><button type="button" id="btn_bcpid" onclick="frmOrder('cpid');"
                                ...
                                >결제금액</button></th>
                                <th><button type="button" id="btn_commission" onclick="frmOrder('commission');"
                                ...
                                >결제 수수료</button></th>
                                <th><button type="button" id="btn_vat" onclick="frmOrder('vat');"
                                ...
                                >부가세</button></th>
                                <th><button type="button" id="btn_settlement" onclick="frmOrder('settlement');"
						...
						<c:choose>
							<c:when test="${!empty resultList}">							
	                            ...
	                            <tr>
	                                ...
	                                <td><span><c:out value="${result.cpid}" /></span></td>
	                                <td><span><c:out value="${result.business_nm}" /></span></td>
	                                <td><span><c:out value="${result.amount}" />원</span></td>
	                                <td><span><c:out value="${result.commission}" />원</span></td>
	                                <td><span><c:out value="${result.vat}" />원</span></td>
	                                <td><span><c:out value="${result.settlement}" />원</span></td>		
                                    <!-- td>
