...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <script src="/js/notice04.js"></script>
						...
						<input type="hidden" name="store_id" id="store_id" value="${sessionScope.role_id eq '1004'? sessionScope.login_id:''}">
							<table>
								<tbody>
									...
									<tr class="input_box input_box_border">
										<td class="input_ttl" colspan="1"><label class="" for="">검색어</label></td>
										<td class="input_desc" colspan="7">
							...
							<div class="btn_box">
								<a href="javascript:notice04_data();" class="a_btn a_btn_blue">검색</a>
							</div>
						</form>
					</div>
	
					<div class="col" id="notice04_data">
					</div>
