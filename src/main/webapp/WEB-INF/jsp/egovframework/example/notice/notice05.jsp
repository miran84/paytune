...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<style>
	 ...
	 <script>
        ...
        <script src="/js/notice05.js"></script>
				...
				<div class="inner clearfix">
					<div class="col">
						...
						<input type="hidden" name="store_id" id="store_id" value="${sessionScope.role_id eq '1003'? sessionScope.login_id:''}">
							<table>
								<tbody>
									<tr class="input_box input_box_border">
										<td class="input_ttl" colspan="1"><label class="" for="">검색조건</label></td>
							...
							<div class="btn_box">
								<a href="javascript:notice05_data();" class="a_btn a_btn_blue">검색</a>
							</div>
						</form>
					</div>
	
					<div class="col" id="notice05_data">
					</div>
