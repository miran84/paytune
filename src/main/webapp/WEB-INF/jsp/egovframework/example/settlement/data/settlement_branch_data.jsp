                    ...
                    <table>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><button type="button" id="btn_period_date3" onclick="frmOrder('period_date3');"
    							<c:if test="${searchSettlementVO.order_id eq 'period_date3' and searchSettlementVO.order_no eq '1'}">class="up"</c:if>
    							<c:if test="${searchSettlementVO.order_id eq 'period_date3' and searchSettlementVO.order_no eq '2'}">class="down"</c:if>                                
                                >정산일</button></th>
                                ...
                                >결제금액</button></th>
                                <th><button type="button" id="btn_commission3" onclick="frmOrder('commission3');"
    							<c:if test="${searchSettlementVO.order_id eq 'commission3' and searchSettlementVO.order_no eq '1'}">class="up"</c:if>
    							<c:if test="${searchSettlementVO.order_id eq 'commission3' and searchSettlementVO.order_no eq '2'}">class="down"</c:if>                                      
                                >결제 수수료</button></th>
                                <th><button type="button" id="btn_vat2" onclick="frmOrder('vat3');"
                                ...
                                >부가세</button></th>
                                <th><button type="button" id="btn_settlement3" onclick="frmOrder('settlement3');"
    							<c:if test="${searchSettlementVO.order_id eq 'settlement3' and searchSettlementVO.order_no eq '1'}">class="up"</c:if>
    							<c:if test="${searchSettlementVO.order_id eq 'settlement3' and searchSettlementVO.order_no eq '2'}">class="down"</c:if>                                      
                                >정산금액</button></th>
						...
						<c:choose>
							<c:when test="${!empty resultList}">							
	                            ...
	                            <tr>
	                                ...
	                                <td><span><c:out value="${result.commission3}" />원</span></td>
	                                <td><span><c:out value="${result.vat3}" />원</span></td>
	                                <td><span><c:out value="${result.settlement3}" />원</span></td>		
                                    <!-- td>
