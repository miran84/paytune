				...
				<div class="col">
				 <strong class="sub_ttl">승인실패조회(단말기 제외)</strong>
					...
					<input type="hidden" name="order_no" id="order_no" value="1"/>							
							...
							<tbody>
								<tr class="input_box input_box_border">
									...
									<td class="input_desc period_search_wrap" colspan="7">
										<button class="btn_first btn_default ${searchHistoryVO.day_type eq 'day' ?'active':''}" type="button" id="day" onclick="today('day');">오늘</button>
                                        ...
                                        <button class="btn_default ${searchHistoryVO.day_type eq 'month3' ?'active':''}" type="button" id="month1" onclick="prevMonth('3','month3');">3개월</button>
										...
										<input type="text" id="start_datetime" name="start_datetime" class="width_150 date_form ui-datepicker-trigger" placeholder="" value="${searchHistoryVO.start_datetime}"><button type="button" class=""></button> 
										<span class="hypen">~</span>
										<input type="text" id="end_datetime" name="end_datetime" class="width_150 date_form ui-datepicker-trigger"	placeholder="" value="${searchHistoryVO.end_datetime}"><button type="button" class=""></button>
									</td>
								</tr>
								<tr class="input_box input_box_border">
									<td class="input_ttl" colspan="1">
						...
						<div class="btn_box">
							<a href="javascript:history_fail_data();" class="a_btn a_btn_blue">내역조회</a> 
							<a href="javascript:history_fail_init();" class="a_btn a_btn_default">초기화</a>							
					</div>
					</form>
				</div>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr class="input_box input_box_border">
                                                ...
                                                <td class="input_desc">805,000원</td>
                                                <td class="input_ttl">
                                                    <label for="">승인건</label>
                                                </td>
                                                <td class="input_desc">89건</td>
                                            </tr>
                                            <tr class="input_box input_box_border">
                                                <td class="input_ttl">
                                                    <label for="">취소금액</label>
                                                </td>
                                                <td class="input_desc">-14,635,000원</td>
                                                <td class="input_ttl">
                                                    <label for="">취소건</label>
                                                </td>
                                                <td class="input_desc">80건</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
