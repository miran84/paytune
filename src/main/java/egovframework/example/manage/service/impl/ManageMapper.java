...
public interface ManageMapper {
	...
	void manageAdd(ManageVO vo) throws IOException, SQLException;
	void manageRoleAdd(ManageVO vo) throws IOException, SQLException;
	
	void manageMod(ManageVO vo) throws IOException, SQLException;
	
	int manageDel(ManageVO vo) throws IOException, SQLException;
	int manageRoleDel(ManageVO vo) throws IOException, SQLException;
	int manageEmailDel(ManageVO vo) throws IOException, SQLException;
	int managePhoneDel(ManageVO vo) throws IOException, SQLException;
	int manageInquiryeDel(ManageVO vo) throws IOException, SQLException;
