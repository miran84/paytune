...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<script src="/js/notice07_write.js"></script>	
							    ...
							    <c:choose>
								    ...
								    <c:otherwise>
		                                ...
		                                <tr class="input_box input_box_border">
											...
											<td class="input_desc" colspan="7">
												<input class="width_all" type="text" id="authdate" name="authdate" value="${noticeVO.authdate }">
											</td>													
										</tr>											
		                                <tr class="input_box input_box_border">
											<td class="input_ttl" colspan="1">
											...
											<td class="input_desc" colspan="7">
												<input class="width_all" type="text" id="amount" name="amount" value="${noticeVO.amount }">
											</td>													
										</tr>											
		                                <tr class="input_box input_box_border">
											<td class="input_ttl order_num" colspan="1">
											...
											<td class="input_desc" colspan="7">
												<input class="width_all" type="text" id="orderno" name="orderno" value="${noticeVO.orderno }">
											</td>													
										</tr>											
		                                <tr class="input_box input_box_border">
											<td class="input_ttl" colspan="1">
											...
											<td class="input_desc" colspan="7">
												<input class="width_all" type="text" id="username" name="username" value="${noticeVO.username }">
											</td>													
										</tr>											
		                                <tr class="input_box input_box_border">
											<td class="input_ttl" colspan="1">
											...
											<td class="input_desc" colspan="7">
												<input class="width_all" type="text" id="userid" name="userid" value="${noticeVO.userid }">
											</td>													
										</tr>											
		                                <tr class="input_box input_box_border editor">
											<td class="input_ttl" colspan="1">
