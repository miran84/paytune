...
<script src="/app/js/manage_all_register.js"></script>
<script>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <th>대표자</th>
                                <td>
                                    <input type="text" type="text" name="ceo" placeholder="" id="ceo">
                                </td>
                            </tr>
                            <tr>
                                <th>사업자등록번호</th>
                                <td>
                                    <input type="text" name="corp_regist_num" placeholder="000-00-00000" id="corp_regist_num">
                                </td>
                            </tr>
                            <tr>
                                <th>대표자생년월일</th>
