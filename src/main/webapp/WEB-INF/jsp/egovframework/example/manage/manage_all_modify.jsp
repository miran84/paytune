...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <script src="/js/manage_all_modify.js"></script>
    <script>
				...
				<div class="col">
					...
					<input type="hidden" name="period" id="period" value="30" />
						<table>
							<tbody>
								...
								<tr class="input_box input_box_border">
									...
									<td class="input_desc" colspan="4"><input class="width_s" type="text" name="corp_regist_num" placeholder="107-87-86839" id="corp_regist_num" value="${manageVo.corp_regist_num }" disabled></td>
								</tr>
								<tr class="input_box input_box_border">
								...
								<tr class="input_box input_box_border">
									...
									<td class="input_desc" colspan="2"><input class="width_240" type="text" name="hompage" placeholder="" id="hompage" value="${manageVo.hompage }" maxlength="100"></td>
								...
								<tr class="input_box input_box_border">
									...
									<td class="input_desc" colspan="2"><input class="width_s" type="text" name="terminal_id" placeholder="" id="terminal_id" value="${manageVo.terminal_id }" maxlength="30">
									</td> -->
                                ...
                                <tr class="input_box input_box_border">
                                    ...
                                    <td class="input_desc" colspan="2">
                                        <select class="width_s" name="settlement_type" id="settlement_type">
									...
									<td class="input_desc" colspan="4">
									<select class="width_s" name="state" placeholder="" id="state" ${sessionScope.role_id eq '1001'?'':'disabled' }>
						...
						<div class="btn_box">
							...
							<a href="javascript:fnSubmit();" id="frmMod" class="a_btn a_btn_blue">수정하기</a> <a href="/manage/manage_all.do"
